...
import { MaderaLogo } from "./MaderaLogo";

interface NotaHeaderProps {
  showFullHeader?: boolean;
}

export function NotaHeader({ showFullHeader = true }: NotaHeaderProps) {
  return (
    <div className="bg-white border-4 border-[#ffac08] rounded-lg p-6">
          ...
          <div className="text-right text-sm text-[#ff7908]">
            <div className="mb-2 space-y-1">
              <p className="font-semibold flex items-center justify-end gap-1">
                <Phone className="w-5 h-5" /> (967) 678-04-63
              </p>
              <p className="font-semibold flex items-center justify-end gap-1">
            ...
            <div className="space-y-1">
              <p className="text-xs flex items-center justify-end gap-1">
                <Mail className="w-5 h-5" /> maderaboutique31@outlook.com
              </p>
              <p className="text-xs flex items-center justify-end gap-1">
                <Mail className="w-5 h-5" /> maderaboutique32@outlook.es
              </p>
            </div>
          </div>
        )}
      ...
      <div className="flex items-center gap-4 text-sm text-[#ff7908] mb-2 px-8">
        <div className="flex-1 flex items-start gap-2 justify-center">
          <Clock className="w-5 h-5 mt-0.5" />
          <div>
            <p className="font-bold mb-1">Lunes a Viernes:</p>
            <p className="text-xs font-medium text-black">9:00 AM a 8:00 PM</p>
          </div>
        </div>
        <div className="flex-1 flex items-start gap-2 justify-center border-l border-[#ffac08] pl-4">
          <Clock className="w-5 h-5 mt-0.5" />
          <div>
            <p className="font-bold mb-1">Sábados</p>
            <p className="text-xs font-medium text-black">9:00 AM a 3:00 PM</p>
          </div>
        </div>
        <div className="flex-1 flex items-start gap-2 justify-center border-l border-[#ffac08] pl-4">
          ...
          <div>
            ...
            <p className="text-xs font-medium text-black">Todas las entregas son después de las 5:00 PM</p>
          </div>
        </div>
      </div>
    </div>
